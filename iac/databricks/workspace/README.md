...
cp terraform.tfvars.example myproject.dev.tfvars
# Edit myproject.dev.tfvars with your workspace details

# 2. Initialize Terraform
terraform init

# 3. Preview changes
terraform plan -var-file=myproject.dev.tfvars

# 4. Apply
terraform apply -var-file=myproject.dev.tfvars
```
