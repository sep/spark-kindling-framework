...
- Comprehensive signal catalog exists in [docs/signal_quick_reference.md](../../contributing/signal_quick_reference.md)
...
- Detailed plan exists in [docs/graph_based_pipe_execution_plan.md](../../contributing/graph_based_pipe_execution_plan.md)
