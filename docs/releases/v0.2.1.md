...
1. **Update framework wheels** (recommended):
   ...
   poe deploy --platform fabric      # For Fabric
   poe deploy --platform databricks  # For Databricks
   poe deploy --platform synapse     # For Synapse
   ```
...
- **Build System**: [docs/build_system.md](../contributing/build_system.md)
- **Release Process**: [docs/release_process.md](../contributing/release_process.md)
- **CI/CD Setup**: [docs/ci_cd_setup.md](../contributing/ci_cd_setup.md)
...
**Full Changelog**: https://github.com/sep/spark-kindling-framework/compare/v0.2.0...v0.2.1
