...
class LocalService(PlatformService):
    ...
    def __init__(self, config, logger):
        ...
        default_workspace = Path(tempfile.gettempdir()) / "kindling_local_workspace"
    ...
    def get_token(self, audience: str = None) -> str:
        ...
        self.logger.debug(f"Local platform does not use real tokens. Audience: {audience}")
    ...
    def get_cluster_info(self) -> Dict[str, Any]:
        ...
        return {"environment": "local", "spark_available": False}
...
@PlatformServices.register(
    name="local", description="Local platform service for development and testing"
)
