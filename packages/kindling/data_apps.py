...
class DataAppManager(DataAppRunner):
    ...
    def _trace(self, operation: str, details: Optional[Dict[str, Any]] = None):
        """Minimal-tier app-lifecycle span, or a no-op CM when tracing is disabled."""
    ...
    def run_app(self, app_name: str) -> Any:
        ...
        with self._trace("run", details={"app_name": app_name}):
            temp_dir = None
            try:
                # Prepare app context
                ...
                with self._trace("install_dependencies", details={"app_name": app_name}):
                ...
                with self._trace("load_code", details={"app_name": app_name}):
                ...
                with self._trace("execute_code", details={"app_name": app_name}):
