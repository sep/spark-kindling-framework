...
def _add_local_package_paths():
    app_dir = Path(__file__).resolve().parent
    candidates = [
        app_dir / "src",
        app_dir.parent / "src",
        *sorted((app_dir / "packages").glob("*/src")),
        *sorted((app_dir.parent / "packages").glob("*/src")),
        *sorted((app_dir.parent.parent / "packages").glob("*/src")),
    ]
