...
def _discover_registration_modules(app_path: Path) -> List[str]:
    ...
    for node in ast.walk(tree):
        ...
        for alias in node.names:
            ...
            if ".entities." in module_name or ".pipes." in module_name:
...
def _render_executor_entrypoint(
    modules: List[str], pipe_ids: Tuple[str, ...], use_dag: bool
) -> str:
    return f'''"""Deployable Kindling executor entrypoint.
...
def app_add_executor(
    ...
    _write_new_file(
        executor_path,
        _render_executor_entrypoint(registration_modules, pipe_ids, use_dag),
    )
