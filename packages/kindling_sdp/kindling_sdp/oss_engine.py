...
:class:`~kindling_sdp.declaration_plan.DeclarationPlan` and declares each
...
from kindling_sdp.capabilities import OSS_SDP, CapabilitySet
from kindling_sdp.declaration_engine import DeclarationEngine
...
class OssSdpEngine(DeclarationEngine):
    ...
    Args:
        entity_registry / pipe_registry / engine_config: see
            :class:`~kindling_sdp.declaration_engine.DeclarationEngine`.
