...
:class:`~kindling_sdp.declaration_plan.DeclarationPlan`. Emitting actual
...
class DeclarationEngine(ABC):
    ...
    lands in Phase 2 (`kindling_sdp` emits the OSS ``pyspark.pipelines``
    surface; `kindling_databricks_sdp` augments it).
