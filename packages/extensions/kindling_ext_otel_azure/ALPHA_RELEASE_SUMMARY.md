# kindling-ext-otel-azure Alpha Release Summary
...
**Distribution Files:**
- `kindling_ext_otel_azure-0.3.0a1-py3-none-any.whl` (7.1 KB)
- `kindling_ext_otel_azure-0.3.0a1.tar.gz` (5.8 KB)

**Location:**
```
packages/extensions/kindling_ext_otel_azure/dist/
```
...
```bash
pip install packages/extensions/kindling_ext_otel_azure/dist/kindling_ext_otel_azure-0.3.0a1-py3-none-any.whl
```
...
kindling:
  extensions:
    - kindling-ext-otel-azure==0.3.0a1  # Alpha version
...
kindling:
  extensions:
    - kindling-ext-otel-azure==0.2.0  # Stable version (Fabric/Synapse only)
```
...
- `packages/extensions/kindling_ext_otel_azure/pyproject.toml` - Updated dependencies and version
- `packages/extensions/kindling_ext_otel_azure/kindling_ext_otel_azure/__init__.py` - Updated version string
- `packages/extensions/kindling_ext_otel_azure/README.md` - Added alpha installation instructions
- `packages/extensions/kindling_ext_otel_azure/CHANGELOG.md` - Created (new file)
