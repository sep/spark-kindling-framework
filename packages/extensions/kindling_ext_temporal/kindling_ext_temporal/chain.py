...
def _chain_events_execute(
    ...
    *,
    ...
    def execute(**entity_dfs):
        ...
        # Shared with the Lakeflow stratified lowering: cross-source
        # condition_id collisions and cross-source cycles are checked in one
        # place so the two lowerings cannot diverge on which rules run.
