...
def test_azure_storage_with_key():
    ...
    storage_container = os.getenv("AZURE_CONTAINER", "your-container")
    ...
    # Test write
    test_path = (
        f"abfss://{storage_container}@{storage_account}.{endpoint_suffix}/test/test_file.txt"
    )
    ...
    try:
        ...
        print("\nYou can now:")
        print(f"  - Access: abfss://{storage_container}@{storage_account}.{endpoint_suffix}/path")
