...
from kindling.pipe_graph import PipeGraphBuilder, GraphCycleError, GraphValidationError
...
class TestPipeGraphIntegration:
    ...
    def test_medallion_architecture(self, builder, pipe_registry):
        ...
        self.register_pipe(pipe_registry, "clean_customers", ["bronze.customers"], "silver.customers")
        ...
        # Build graph
        pipe_ids = [
            "ingest_orders", "ingest_customers", "ingest_products",
    ...
    def test_complex_workflow(self, builder, pipe_registry):
        ...
        self.register_pipe(pipe_registry, "clean_inventory", ["bronze.inventory"], "silver.inventory")
        self.register_pipe(pipe_registry, "clean_customers", ["bronze.customers"], "silver.customers")
        ...
        pipe_ids = [
            "raw_sales", "raw_inventory", "raw_customers",
            "clean_sales", "clean_inventory", "clean_customers",
            "sales_metrics", "inventory_analysis",
            "exec_dashboard"
        ]
