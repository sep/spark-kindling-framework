"""
Unit tests for StandaloneService platform implementation.
...
class TestStandaloneServiceInitialization:
    """Test StandaloneService initialization and configuration"""

    def test_initialization_with_default_config(self, mock_logger):
        """Test service initializes with default configuration"""
        config = {}
        service = StandaloneService(config, mock_logger)

        assert service.get_platform_name() == "standalone", "Platform name should be 'local'"
        ...
        assert (
            service.local_workspace_path.name == "kindling_standalone_workspace"
        ), "Default workspace directory name should be 'kindling_standalone_workspace'"
        assert (
    ...
    def test_creates_workspace_directory(self, temp_workspace, mock_logger):
        ...
        ), "StandaloneService should create workspace directory if it doesn't exist"
        assert (
            service.local_workspace_path == new_workspace
        ), f"Workspace path should be set to {new_workspace}"


class TestStandaloneServiceFileOperations:
...
class TestStandaloneServiceNotebooks:
...
class TestStandaloneServicePaths:
...
class TestStandaloneServiceInfo:
    ...
    def test_get_workspace_info(self, temp_workspace, mock_logger):
        ...
        assert info["platform"] == "standalone", "platform should be 'local'"
    ...
    def test_get_cluster_info_no_spark(self, temp_workspace, mock_logger):
        ...
        assert info["environment"] == "standalone", "environment should be 'local'"
    ...
    def test_get_platform_name(self, temp_workspace, mock_logger):
        ...
        assert (
            service.get_platform_name() == "standalone"
        ), "get_platform_name() should return 'local'"
    ...
    def test_get_token(self, temp_workspace, mock_logger):
        ...
        ), "get_token() should return 'standalone-dummy-token' for standalone platform"


class TestStandaloneServiceEdgeCases:
