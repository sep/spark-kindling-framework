...
try:
    ...
    from kindling.data_entities import Entity, EntityRegistry
...
class SynapseSystemTestApp:
    ...
    def _get_results_path(self) -> str:
        ...
        results_prefix = os.getenv("RESULTS_PATH_PREFIX", "system-test-results/kda-test-app")
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
